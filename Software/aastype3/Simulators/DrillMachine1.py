"""
SimPy-based Drill Machine 1 Simulator
"""
...
# ============== Configuration ==============
MACHINE_ID = "DrillMachine_1"
DRILL_SPEED_FACTOR = 0.5
BASE_SETUP_TIME = 0.5
PORT = 8090
...
async def invoke_drill(request: Request):
    ...
    if not properties:
        raise HTTPException(status_code=400, detail="Failed to map inputs")
    ...
    # Save report after each operation
    sim_report.save_all()
