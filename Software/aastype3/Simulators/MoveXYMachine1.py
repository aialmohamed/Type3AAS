"""
SimPy-based Move XY Machine 1 Simulator
Handles movement operations for Machine 1
"""
...
# ============== Configuration ==============
MACHINE_ID = "MoveXY_Machine_1"
MOVE_SPEED_FACTOR = 0.02  # seconds per unit distance
BASE_SETUP_TIME = 0.5
PORT = 8092
